...
<template>
  <footer class="bg-surface-container-lowest w-full border-t border-outline-variant/15 font-manrope text-sm tracking-wide">
    <div class="max-w-screen-2xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
      <div class="space-y-4">
        <div class="text-3xl md:text-4xl tracking-tighter font-rayforce mb-10">
          <span class="text-3xl md:text-5xl  tracking-tighter text-primary  font-rayforce">Rayforce</span>
        </div>
        <p class="text-on-surface-variant max-w-xs leading-relaxed text-xs">
          Soluciones eléctricas, materiales de calidad y servicios integrales. Más de 2,000 productos disponibles para proyectos residenciales, comerciales e industriales.
        </p>
      </div>
    ...
    <!-- Redes Sociales -->
    <div class="max-w-screen-2xl mx-auto px-8 py-8 border-t border-outline-variant/15 flex flex-col items-center justify-center gap-4">
      <span class="font-bold text-primary text-xs uppercase tracking-widest block mb-2">Síguenos en nuestras redes</span>
      <div class="flex gap-6 items-center">
        <a href="https://www.facebook.com/people/Rayforce/61586457534163/#" target="_blank" class="w-10 h-10 rounded-full bg-surface-container-high hover:bg-primary hover:text-white transition-all flex items-center justify-center text-on-surface-variant">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
          </svg>
        </a>
        <a href="https://www.instagram.com/rayforce.mx/" target="_blank" class="w-10 h-10 rounded-full bg-surface-container-high hover:bg-primary hover:text-white transition-all flex items-center justify-center text-on-surface-variant">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="https://www.tiktok.com/@rayforce.mx" target="_blank" class="w-10 h-10 rounded-full bg-surface-container-high hover:bg-primary hover:text-white transition-all flex items-center justify-center text-on-surface-variant">
          <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 448 512" aria-hidden="true">
