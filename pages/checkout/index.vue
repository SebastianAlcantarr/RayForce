<template>
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
    <div class="lg:col-span-7 space-y-16">
      <section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
          <div class="flex flex-col gap-2">
            ...
            <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="Escribe tu nombre" type="text" />
          </div>
          <div class="flex flex-col gap-2">
            <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">Apellido</label>
            <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="Escribe tu apellido" type="text" />
          </div>
          <div class="md:col-span-2 flex flex-col gap-2">
            <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">Dirección Física</label>
            <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="Calle, número, colonia, empresa" type="text" />
          </div>
          <div class="flex flex-col gap-2">
            <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">Ciudad</label>
            <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="Ciudad" type="text" />
          </div>
          <div class="flex flex-col gap-2">
            <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">Código Postal</label>
            <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="Código Postal" type="text" />
          </div>
        </div>
      </section>
      ...
      <section>
        <div class="flex items-center gap-4 mb-8">
          <span class="text-xs font-bold font-inter bg-primary text-white w-6 h-6 flex items-center justify-center rounded-full">03</span>
          <h2 class="text-2xl font-extrabold tracking-tight uppercase">Método de Pago</h2>
        </div>
        <div class="space-y-6">
          <div class="grid grid-cols-3 gap-4">
            <label class="cursor-pointer">
              <input checked class="peer sr-only" name="payment" type="radio" />
              <div class="py-4 border border-outline-variant/20 bg-surface-container-low peer-checked:bg-primary-container peer-checked:border-primary text-center rounded-lg transition-all">
                <span class="material-symbols-outlined text-2xl">credit_card</span>
                <p class="text-[10px] font-bold uppercase mt-1">Tarjeta</p>
              </div>
            </label>
            <label class="cursor-pointer">
              ...
              <div class="py-4 border border-outline-variant/20 bg-surface-container-low peer-checked:bg-primary-container peer-checked:border-primary text-center rounded-lg transition-all">
                ...
                <p class="text-[10px] font-bold uppercase mt-1">Transferencia</p>
              </div>
            </label>
            <label class="cursor-pointer">
              <input class="peer sr-only" name="payment" type="radio" />
              <div class="py-4 border border-outline-variant/20 bg-surface-container-low peer-checked:bg-primary-container peer-checked:border-primary text-center rounded-lg transition-all">
                ...
                <p class="text-[10px] font-bold uppercase mt-1">MercadoPago</p>
              </div>
            </label>
          </div>
          <div class="bg-surface-container-low p-8 rounded-xl space-y-6">
            <div class="flex flex-col gap-2">
              <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">Número de Tarjeta</label>
              <div class="relative">
                <input class="w-full bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all pr-10" placeholder="0000 0000 0000 0000" type="text" />
                <span class="material-symbols-outlined absolute right-0 top-3 text-outline-variant">lock</span>
              </div>
            </div>
            <div class="grid grid-cols-2 gap-8">
              <div class="flex flex-col gap-2">
                <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">Expiración</label>
                <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="MM/YY" type="text" />
              </div>
              <div class="flex flex-col gap-2">
                <label class="font-inter text-[11px] uppercase tracking-wider text-on-surface-variant">CVV</label>
                <input class="bg-surface-container-high border-none border-b border-outline-variant/30 px-0 py-3 text-sm focus:ring-0 transition-all" placeholder="123" type="text" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="pt-8 grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-outline-variant/10">
        <div class="flex items-start gap-4">
          ...
          <div>
            <h4 class="font-bold text-xs uppercase">Garantía Industrial</h4>
            <p class="text-xs text-on-surface-variant mt-1 leading-relaxed">Cada componente está respaldado por nuestra garantía de rendimiento a largo plazo.</p>
          </div>
        </div>
        <div class="flex items-start gap-4">
          ...
          <div>
            ...
            <p class="text-xs text-on-surface-variant mt-1 leading-relaxed">Protocolos de encriptación AES-256 bits protegen tus datos de compra.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="lg:col-span-5">
      <div class="sticky top-32 space-y-6">
        <div class="bg-surface-container-lowest shadow-[0_40px_40px_-15px_rgba(45,51,56,0.06)] p-10 rounded-xl border border-outline-variant/5">
          ...
          <button class="w-full mt-10 bg-primary hover:bg-primary-dim text-on-primary py-5 rounded-md font-extrabold uppercase tracking-[0.15em] text-sm transition-all active:scale-95 shadow-lg shadow-primary/20" type="button">
            Completar Compra
          </button>
          <div class="mt-8 flex justify-center gap-6 opacity-30">
            <span class="material-symbols-outlined text-2xl">payments</span>
            <span class="material-symbols-outlined text-2xl">universal_currency</span>
