...
function getWooAuth() {
  ...
  const auth = Buffer$1.from(`${key}:${secret}`).toString("base64");
...
const bulkUpdate_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: bulkUpdate_post
});
...
const createProduct_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: createProduct_post
});
...
const exportOrders_get = defineEventHandler(async (event) => {
  ...
  try {
    ...
    return {
      ...
      data: Buffer$1.from("\uFEFF" + csvContent, "utf-8").toString("base64"),
...
const exportOrders_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: exportOrders_get
});
...
const searchProduct_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: searchProduct_get
});
...
const updateProduct_put$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: updateProduct_put
});
...
const uploadImage_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const verifyPassword_post = defineEventHandler(async (event) => {
  ...
  const now = Date.now();
  const token = Buffer$1.from(`${now}:${adminPassword.slice(0, 4)}`).toString("base64");
